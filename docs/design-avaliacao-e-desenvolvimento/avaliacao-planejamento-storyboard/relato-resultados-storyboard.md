...
### 3.3. Caracterização dos Envolvidos
...
### 3.8. Diretrizes para o Reprojeto

Para finalizar, o relato deve propor intervenções práticas para solucionar as falhas mapeadas. A equipe tem o dever de priorizar as correções com base no Grau de Severidade levantado no tópico anterior. Essas soluções serão o ponto de partida exigido para a construção dos Protótipos de Papel.

## 4. Fundamentação Teórica

A modelagem deste roteiro de relato está estritamente alinhada com as recomendações de consolidação e relato de resultados descritas na bibliografia base da disciplina (em especial, os tópicos abordados no Capítulo 11):
...
| `1.2`  | 19/05/2026 | Alteração das tabelas       | [Luara Cristiana](https://github.com/luacristiana) | -- |    -- |
