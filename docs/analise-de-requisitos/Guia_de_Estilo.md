...
> Documento de diretrizes de design para o sistema de Secretaria de Educação do Distrito Federal - IHC/UnB 2026

---

## Introdução

Este guia de estilo estabelece as diretrizes visuais e de interação para o redesign do sistema de matrículas online da Secretaria de Estado de Educação do Distrito Federal (SEEDF). O sistema tem como função principal permitir que responsáveis legais realizem a matrícula e rematrícula de estudantes da rede pública de ensino do DF.

#### Organização e conteúdo do guia de estilo

A organização do guia de estilo seguirá a proposta de Marcus e Mayhew, conforme referenciado em Barbosa [1](../../assets/guia_de_estilo/estrutur-guia-de-estilo.png): 
...
* Múltiplos perfis de usuário com diferentes níveis de letramento digital
...
| Azul Hover | `#155BCB` | Estado hover de botões primários |
| Azul Escuro (secundária) | `#071D41` | Cabeçalhos, rodapé, destaques |
| Verde Sucesso | `#168821` | Confirmações, matrículas concluídas |
...
O sistema deve adotar uma interface limpa e orientada a tarefas, com foco no fluxo de matrículas. Informações secundárias devem ser separadas da área funcional principal, evitando poluição visual.
...
* **Destrutivo** (`#DC3545`): ação irreversível (ex.: "Cancelar solicitação")
...
* Textos alternativos em todas as imagens e ícones funcionais
...
> 4. BRASIL. *Padrão Digital de Governo — Design System Gov.br.* Disponível em: [https://www.gov.br/ds](https://www.gov.br/ds)
> 
---
...
| `1.1` | 14/05/2026 | Correções gramaticais | [Luara Cristiana](https://github.com/luacristiana) |  |
